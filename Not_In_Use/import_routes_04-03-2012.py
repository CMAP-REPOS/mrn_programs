#############################################################################
# IMPORT_ROUTES.PY                                                          #
#  Craig Heither, last revised 01/24/2012                                   #
#                                                                           #
...
if param1 != '':
    ...
    flag = "1"
    rail_routes = "railnet_route_rail_lines"
    railrt = railnet + "\\railnet_route_rail_lines"
    itinerary = d + "\\mrn.gdb\\itinerary"
    orig_itinerary_dbf = d + "\\itin_" + x1 + ".dbf"
    ...
    flag = "2"
    rail_routes = "all_runs"
    railrt = railnet + "\\all_runs"
    itinerary = d + "\\mrn.gdb\\all_runs_itin"
    orig_itinerary_dbf = d + "\\all_runs_itin_" + x1 + ".dbf"
...
if os.path.exists(rte_updt):
    ...
    for d_row in datacur:
        ...
        if flag == "1":                                          # update variables unique to railnet_rail_routes
            b_row.SCENARIO = d_row.getValue("scen1")
            b_row.FTR_HEADWAY = d_row.getValue("fhdwy1")
            b_row.ROCKFORD = d_row.getValue("rock1")
