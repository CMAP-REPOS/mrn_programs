...
#                        -------------------------                          #
#  revision summary:                                                        #
#   6-03-10: added coding to update route geometry when run.                #
#   9-10-10: updated for ArcMap 10 (arcgisscripting replaced by arcpy)      #
#                                                                           #
#                                                                           #
#############################################################################
...
rows = arcpy.SearchCursor(railnet_arc)
row = rows.Next()
f = 1                                   # row id number
...
if os.path.exists(rte_updt):
    ...
    arcpy.Delete_management(railnet_route_rail_lines)
