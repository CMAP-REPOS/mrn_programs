...
orig_itinerary_dbf = os.path.join(tempdir, param4 + '_itin_' + x1 + '.dbf')
...
if param1 != '':
    ...
    flag = "1"
    y = srcdir + "$" + tempdir + "$" + orig_itinerary_dbf + "$" + param1 + "$" + flag + "$X"  # SAS -sysparm parameters
    ...
    flag = "2"
    y = srcdir + "$" + tempdir + "$" + orig_itinerary_dbf + "$" + param2 + "$" + flag + "$" + param3  # SAS -sysparm parameters
else:
