...
temp_start_join_shp = os.path.join(tempdir, 'temp_start_join.shp')
temp_end_join_shp = os.path.join(tempdir, 'temp_end_join.shp')
...
if os.path.exists(new_mile_dbf):
    env.workspace = os.path.join(gdb, 'railnet')             ## point inside feature dataset
    ...
    for fc in fcs:
        ...
        itinerary = os.path.join(gdb, fc + '_itin')
